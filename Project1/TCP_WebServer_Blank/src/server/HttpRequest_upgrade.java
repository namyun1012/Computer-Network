...
enum StatusCode{
	OK, CREATED, BAD_REQUEST, FORBIDDEN, NOT_FOUND, HTTP_VERSION_NOT_SUPPORTED, INTERNAL_SERVER_ERROR
}
...
final class HttpRequest_upgrade implements Runnable {
    ...
    private void sendHeaderLines(DataOutputStream os) throws Exception{
    	...
    	case OK:
    		...
    		contentTypeLine += contentLength + new Integer(1024).toString()  /* requestedFile.length() 우선 1024로 고정 */ /*     MIssion 6     */ + CRLF;
    		
    		break;
    	default:
    		contentTypeLine += "text/html" /*     MIssion 7     */ + CRLF;  // default일 경우 error message
    	}
	...
	private String parseRequestLine(java.lang.String requestLine) {
        ...
        //Modify to your path
//        fileName = "." + fileName ;
        fileName = "C:\\대학 수업\\2-2\\컴퓨터네트워크\\과제\\Complete\\Project_1\\TCP_Web server_Blank\\TCP_WebServer_Blank\\src\\server" + fileName;
